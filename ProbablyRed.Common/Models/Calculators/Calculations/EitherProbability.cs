...
{
    public class EitherProbability : CalculatorBase, IStrategyCalculator
    {
        
        [ReadOnly(true)]
        public string CalculationName { get { return "EitherProbability"; } }
        [ReadOnly(true)]
        public string CalculationDescription { get { return "Calculates the probability either params coalesces (e.g. 0.5 + 0.5 – 0.5*0.5 = 0.75)"; } }
        ...
        public CalculationResult Calculate()
        {
            ...
            {
                result.Result = ProbabilityA + ProbabilityB - (ProbabilityA * ProbabilityB);
                result.Success = true;
            }
