...
{
    public class CombinedProbabilityTripple : CalculatorBase, IStrategyCalculator
    {
        [ReadOnly(true)]
        public string CalculationName { get { return "CombinedProbabilityTripple"; } }
        [ReadOnly(true)]
        public string CalculationDescription { get { return "Calculates the probability 3 params coalesce combined (e.g. 0.5 * 0.5 * 0.5 = 0.25)"; } }
        ...
        public CalculationResult Calculate()
        {
            ...
            {
                result.Result = ProbabilityA * ProbabilityB * ProbabilityC;
                result.Success = true;
            }
        ...
        public IEnumerable<CalculatorValidationResult> Validate()
        {
            ...
            if (invalidRange(ProbabilityC)) results.Add(new CalculatorValidationResult("ProbabilityC must be within 0 and 1"));
        ...
        [DefaultValue(typeof(Decimal), "0.0")]
        [Range(0, 1, ErrorMessage = "Range should be between 0 and 1")]
        public decimal ProbabilityC { get; set; }
